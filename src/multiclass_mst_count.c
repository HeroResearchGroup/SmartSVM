...
#define __PYX_HAVE__smartsvm__multiclass_mst_count
#define __PYX_HAVE_API__smartsvm__multiclass_mst_count
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'smartsvm.multiclass_mst_count' */
__PYX_EXTERN_C DL_IMPORT(void) c_multiclass_mst_count(double *, long *, long, long, long, long *, long *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_long = { "long", NULL, sizeof(long), { 0 }, 0, IS_UNSIGNED(long) ? 'U' : 'I', IS_UNSIGNED(long), 0 };
#define __Pyx_MODULE_NAME "smartsvm.multiclass_mst_count"
int __pyx_module_is_main_smartsvm__multiclass_mst_count = 0;

/* Implementation of 'smartsvm.multiclass_mst_count' */
...
static const char __pyx_k_actual_trees[] = "actual_trees";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_multiclass_mst_count[] = "multiclass_mst_count";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_src_multiclass_mst_count_pyx[] = "src/multiclass_mst_count.pyx";
static const char __pyx_k_smartsvm_multiclass_mst_count[] = "smartsvm.multiclass_mst_count";
...
static PyObject *__pyx_n_s_actual_trees;
...
static PyObject *__pyx_n_s_multiclass_mst_count;
...
static PyObject *__pyx_n_s_smartsvm_multiclass_mst_count;
static PyObject *__pyx_kp_s_src_multiclass_mst_count_pyx;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_weights;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_8smartsvm_20multiclass_mst_count_multiclass_mst_count(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_labels, long __pyx_v_nClass, long __pyx_v_nTrees); /* proto */
...
/* "src/multiclass_mst_count.pyx":17
...
/* Python wrapper */
static PyObject *__pyx_pw_8smartsvm_20multiclass_mst_count_1multiclass_mst_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8smartsvm_20multiclass_mst_count_multiclass_mst_count[] = "\n    ";
static PyMethodDef __pyx_mdef_8smartsvm_20multiclass_mst_count_1multiclass_mst_count = {"multiclass_mst_count", (PyCFunction)__pyx_pw_8smartsvm_20multiclass_mst_count_1multiclass_mst_count, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8smartsvm_20multiclass_mst_count_multiclass_mst_count};
static PyObject *__pyx_pw_8smartsvm_20multiclass_mst_count_1multiclass_mst_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("multiclass_mst_count (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_weights,&__pyx_n_s_labels,&__pyx_n_s_nClass,&__pyx_n_s_nTrees,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_labels)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("multiclass_mst_count", 1, 4, 4, 1); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nClass)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("multiclass_mst_count", 1, 4, 4, 2); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nTrees)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("multiclass_mst_count", 1, 4, 4, 3); __PYX_ERR(0, 17, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "multiclass_mst_count") < 0)) __PYX_ERR(0, 17, __pyx_L3_error)
      }
    ...
    __pyx_v_nClass = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_nClass == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_nTrees = __Pyx_PyInt_As_long(values[3]); if (unlikely((__pyx_v_nTrees == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("multiclass_mst_count", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 17, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smartsvm.multiclass_mst_count.multiclass_mst_count", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 0, "weights", 0))) __PYX_ERR(0, 18, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_labels), __pyx_ptype_5numpy_ndarray, 0, "labels", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_r = __pyx_pf_8smartsvm_20multiclass_mst_count_multiclass_mst_count(__pyx_self, __pyx_v_weights, __pyx_v_labels, __pyx_v_nClass, __pyx_v_nTrees);
...
static PyObject *__pyx_pf_8smartsvm_20multiclass_mst_count_multiclass_mst_count(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_labels, long __pyx_v_nClass, long __pyx_v_nTrees) {
  long __pyx_v_nObs;
  long __pyx_v_actual_trees;
  ...
  __Pyx_RefNannySetupContext("multiclass_mst_count", 0);
  ...
  __pyx_pybuffernd_labels.rcbuffer = &__pyx_pybuffer_labels;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_labels.rcbuffer->pybuffer, (PyObject*)__pyx_v_labels, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  ...
  /* "src/multiclass_mst_count.pyx":28
 ...
 */
  __pyx_v_nObs = (__pyx_v_weights->dimensions[0]);

  /* "src/multiclass_mst_count.pyx":31
 * 
 *     cdef np.ndarray[long, ndim=2, mode='c'] C
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_v_nClass); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_long(__pyx_v_nClass); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_ctypes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_c_long); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 31, __pyx_L1_error)
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_C.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_7 < 0)) {
      PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_C.rcbuffer->pybuffer, (PyObject*)__pyx_v_C, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "src/multiclass_mst_count.pyx":33
 *     C = np.zeros((nClass, nClass), dtype=ctypes.c_long)
 * 
 *     c_multiclass_mst_count(&weights[0, 0], &labels[0], nTrees, nObs, nClass,             # <<<<<<<<<<<<<<
 *             &C[0, 0], &actual_trees)
 ...
 */
  ...
  /* "src/multiclass_mst_count.pyx":34
 * 
 *     c_multiclass_mst_count(&weights[0, 0], &labels[0], nTrees, nObs, nClass,
 *             &C[0, 0], &actual_trees)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  c_multiclass_mst_count((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_weights.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_weights.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_weights.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(long *, __pyx_pybuffernd_labels.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_labels.diminfo[0].strides))), __pyx_v_nTrees, __pyx_v_nObs, __pyx_v_nClass, (&(*__Pyx_BufPtrCContig2d(long *, __pyx_pybuffernd_C.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_C.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_C.diminfo[1].strides))), (&__pyx_v_actual_trees));

  /* "src/multiclass_mst_count.pyx":36
 *             &C[0, 0], &actual_trees)
 * 
 *     return C, actual_trees             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __Pyx_PyInt_From_long(__pyx_v_actual_trees); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_actual_trees, __pyx_k_actual_trees, sizeof(__pyx_k_actual_trees), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_multiclass_mst_count, __pyx_k_multiclass_mst_count, sizeof(__pyx_k_multiclass_mst_count), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_smartsvm_multiclass_mst_count, __pyx_k_smartsvm_multiclass_mst_count, sizeof(__pyx_k_smartsvm_multiclass_mst_count), 0, 0, 1, 1},
  {&__pyx_kp_s_src_multiclass_mst_count_pyx, __pyx_k_src_multiclass_mst_count_pyx, sizeof(__pyx_k_src_multiclass_mst_count_pyx), 0, 0, 1, 0},
 ...
 *         np.ndarray[long, ndim=1, mode="c"] labels not None,
 */
  __pyx_tuple__11 = PyTuple_Pack(7, __pyx_n_s_weights, __pyx_n_s_labels, __pyx_n_s_nClass, __pyx_n_s_nTrees, __pyx_n_s_nObs, __pyx_n_s_actual_trees, __pyx_n_s_C); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__11);
  __Pyx_GIVEREF(__pyx_tuple__11);
  __pyx_codeobj__12 = (PyObject*)__Pyx_PyCode_New(4, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__11, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_multiclass_mst_count_pyx, __pyx_n_s_multiclass_mst_count, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__12)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmulticlass_mst_count(void); /*proto*/
PyMODINIT_FUNC initmulticlass_mst_count(void)
#else
PyMODINIT_FUNC PyInit_multiclass_mst_count(void); /*proto*/
PyMODINIT_FUNC PyInit_multiclass_mst_count(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_multiclass_mst_count(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("multiclass_mst_count", __pyx_methods, __pyx_k__10, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_smartsvm__multiclass_mst_count) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "smartsvm.multiclass_mst_count")) {
      if (unlikely(PyDict_SetItemString(modules, "smartsvm.multiclass_mst_count", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "src/multiclass_mst_count.pyx":5
 * """
 * 
 * import ctypes             # <<<<<<<<<<<<<<
 * import cython
 ...
 */
  ...
  /* "src/multiclass_mst_count.pyx":8
 * import cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *         np.ndarray[long, ndim=1, mode="c"] labels not None,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8smartsvm_20multiclass_mst_count_1multiclass_mst_count, NULL, __pyx_n_s_smartsvm_multiclass_mst_count); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_multiclass_mst_count, __pyx_t_1) < 0) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "src/multiclass_mst_count.pyx":1
 * """             # <<<<<<<<<<<<<<
 * 
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init smartsvm.multiclass_mst_count", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init smartsvm.multiclass_mst_count");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
