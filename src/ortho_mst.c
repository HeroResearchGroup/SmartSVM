...
#define __PYX_HAVE__smartsvm__ortho_mst
#define __PYX_HAVE_API__smartsvm__ortho_mst
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'smartsvm.ortho_mst' */
__PYX_EXTERN_C DL_IMPORT(void) c_ortho_mst_count(double *, long *, long, long, long *, long *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_long = { "long", NULL, sizeof(long), { 0 }, 0, IS_UNSIGNED(long) ? 'U' : 'I', IS_UNSIGNED(long), 0 };
#define __Pyx_MODULE_NAME "smartsvm.ortho_mst"
int __pyx_module_is_main_smartsvm__ortho_mst = 0;

/* Implementation of 'smartsvm.ortho_mst' */
...
static const char __pyx_k_ortho_mst_count[] = "ortho_mst_count";
static const char __pyx_k_src_ortho_mst_pyx[] = "src/ortho_mst.pyx";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_smartsvm_ortho_mst[] = "smartsvm.ortho_mst";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Orthogonal_MST_Counter_Compute[] = "\nOrthogonal MST Counter\n\nCompute the first `k` orthogonal minimal spanning trees and return the number \nof edges that come from different samples.\n\n";
...
static PyObject *__pyx_n_s_ortho_mst_count;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_smartsvm_ortho_mst;
static PyObject *__pyx_kp_s_src_ortho_mst_pyx;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_weights;
static PyObject *__pyx_pf_8smartsvm_9ortho_mst_ortho_mst_count(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_labels, long __pyx_v_nTrees); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_8smartsvm_9ortho_mst_1ortho_mst_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8smartsvm_9ortho_mst_ortho_mst_count[] = "\n    ortho_mst_count(weights, labels, nTrees)\n\n    Takes the weight matrix and constructs nTree minimal spanning trees. For \n    each minimal spanning tree the number of edges that connect points with \n    different labels is calculated. The total number of edges for which this \n    occurs is returned. For the MST algorithm the algorithm of Whitney is used \n    (see the C file).\n\n    param: weights -- a 2-d symmetric numpy array of np.float64.\n    param: labels -- a 1-d numpy array of np.intc\n    param: nTrees -- the number of minimal spanning trees to construct\n\n    ";
static PyMethodDef __pyx_mdef_8smartsvm_9ortho_mst_1ortho_mst_count = {"ortho_mst_count", (PyCFunction)__pyx_pw_8smartsvm_9ortho_mst_1ortho_mst_count, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8smartsvm_9ortho_mst_ortho_mst_count};
static PyObject *__pyx_pw_8smartsvm_9ortho_mst_1ortho_mst_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_weights = 0;
  PyArrayObject *__pyx_v_labels = 0;
  long __pyx_v_nTrees;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("ortho_mst_count (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_weights,&__pyx_n_s_labels,&__pyx_n_s_nTrees,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_labels)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("ortho_mst_count", 1, 3, 3, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nTrees)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ortho_mst_count", 1, 3, 3, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ortho_mst_count") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    ...
    __pyx_v_nTrees = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_nTrees == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ortho_mst_count", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smartsvm.ortho_mst.ortho_mst_count", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 0, "weights", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_labels), __pyx_ptype_5numpy_ndarray, 0, "labels", 0))) __PYX_ERR(0, 20, __pyx_L1_error)
  __pyx_r = __pyx_pf_8smartsvm_9ortho_mst_ortho_mst_count(__pyx_self, __pyx_v_weights, __pyx_v_labels, __pyx_v_nTrees);
...
static PyObject *__pyx_pf_8smartsvm_9ortho_mst_ortho_mst_count(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_labels, long __pyx_v_nTrees) {
  long __pyx_v_nObs;
  long __pyx_v_count;
  ...
  __Pyx_RefNannySetupContext("ortho_mst_count", 0);
  ...
  __pyx_pybuffernd_labels.rcbuffer = &__pyx_pybuffer_labels;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_labels.rcbuffer->pybuffer, (PyObject*)__pyx_v_labels, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
 ...
 */
  c_ortho_mst_count((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_weights.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_weights.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_weights.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(long *, __pyx_pybuffernd_labels.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_labels.diminfo[0].strides))), __pyx_v_nTrees, __pyx_v_nObs, (&__pyx_v_count), (&__pyx_v_actual_trees));

  /* "src/ortho_mst.pyx":45
 *             &actual_trees)
 * 
 *     return count, actual_trees             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __Pyx_PyInt_From_long(__pyx_v_count); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_From_long(__pyx_v_actual_trees); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 45, __pyx_L1_error)
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "ortho_mst",
    __pyx_k_Orthogonal_MST_Counter_Compute, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_ortho_mst_count, __pyx_k_ortho_mst_count, sizeof(__pyx_k_ortho_mst_count), 0, 0, 1, 1},
  {&__pyx_n_s_range, __pyx_k_range, sizeof(__pyx_k_range), 0, 0, 1, 1},
  {&__pyx_n_s_smartsvm_ortho_mst, __pyx_k_smartsvm_ortho_mst, sizeof(__pyx_k_smartsvm_ortho_mst), 0, 0, 1, 1},
  {&__pyx_kp_s_src_ortho_mst_pyx, __pyx_k_src_ortho_mst_pyx, sizeof(__pyx_k_src_ortho_mst_pyx), 0, 0, 1, 0},
 ...
 *     """
 */
  __pyx_tuple__10 = PyTuple_Pack(6, __pyx_n_s_weights, __pyx_n_s_labels, __pyx_n_s_nTrees, __pyx_n_s_nObs, __pyx_n_s_count, __pyx_n_s_actual_trees); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(3, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_ortho_mst_pyx, __pyx_n_s_ortho_mst_count, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initortho_mst(void); /*proto*/
PyMODINIT_FUNC initortho_mst(void)
#else
PyMODINIT_FUNC PyInit_ortho_mst(void); /*proto*/
PyMODINIT_FUNC PyInit_ortho_mst(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ortho_mst(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ortho_mst", __pyx_methods, __pyx_k_Orthogonal_MST_Counter_Compute, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_smartsvm__ortho_mst) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "smartsvm.ortho_mst")) {
      if (unlikely(PyDict_SetItemString(modules, "smartsvm.ortho_mst", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8smartsvm_9ortho_mst_1ortho_mst_count, NULL, __pyx_n_s_smartsvm_ortho_mst); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_ortho_mst_count, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init smartsvm.ortho_mst", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init smartsvm.ortho_mst");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
